...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <!-- CSS Reset -->
		<link rel="stylesheet" type="text/css" href="<?=HOME; ?>/views/def_view/dash/reset.css" tppabs="http://www.xooom.pl/work/magicadmin/css/reset.css" media="screen" />
       
        <!-- Fluid 960 Grid System - CSS framework -->
		<link rel="stylesheet" type="text/css" href="<?=HOME; ?>/views/def_view/dash/grid.css" tppabs="http://www.xooom.pl/work/magicadmin/css/grid.css" media="screen" />
        ...
        <!-- Main stylesheet -->
        <link rel="stylesheet" type="text/css" href="<?=HOME; ?>/views/def_view/dash/styles.css" tppabs="http://www.xooom.pl/work/magicadmin/css/styles.css" media="screen" />
        
        <!-- WYSIWYG editor stylesheet -->
        <link rel="stylesheet" type="text/css" href="<?=HOME; ?>/views/def_view/dash/jquery.wysiwyg.css" tppabs="http://www.xooom.pl/work/magicadmin/css/jquery.wysiwyg.css" media="screen" />
        
        <!-- Table sorter stylesheet -->
        <link rel="stylesheet" type="text/css" href="<?=HOME; ?>/views/def_view/dash/tablesorter.css" tppabs="http://www.xooom.pl/work/magicadmin/css/tablesorter.css" media="screen" />
        
        <!-- Thickbox stylesheet -->
        <link rel="stylesheet" type="text/css" href="<?=HOME; ?>/views/def_view/dash/thickbox.css" tppabs="http://www.xooom.pl/work/magicadmin/css/thickbox.css" media="screen" />
        
        <!-- Themes. Below are several color themes. Uncomment the line of your choice to switch to different color. All styles commented out means blue theme. -->
        <link rel="stylesheet" type="text/css" href="<?=HOME; ?>/views/def_view/dash/theme-blue.css" tppabs="http://www.xooom.pl/work/magicadmin/css/theme-blue.css" media="screen" />
		...
		<script type="text/javascript" src="<?=HOME; ?>/views/def_view/dash/jquery-1.3.2.min.js" tppabs="http://www.xooom.pl/work/magicadmin/js/jquery-1.3.2.min.js"></script>
        
		<!-- JQuery WYSIWYG plugin script -->
		<script type="text/javascript" src="<?=HOME; ?>/views/def_view/dash/jquery.wysiwyg.js" tppabs="http://www.xooom.pl/work/magicadmin/js/jquery.wysiwyg.js"></script>
        
        <!-- JQuery tablesorter plugin script-->
		<script type="text/javascript" src="<?=HOME; ?>/views/def_view/dash/jquery.tablesorter.min.js" tppabs="http://www.xooom.pl/work/magicadmin/js/jquery.tablesorter.min.js"></script>
        
		<!-- JQuery pager plugin script for tablesorter tables -->
		<script type="text/javascript" src="<?=HOME; ?>/views/def_view/dash/jquery.tablesorter.pager.js" tppabs="http://www.xooom.pl/work/magicadmin/js/jquery.tablesorter.pager.js"></script>
        
		<!-- JQuery password strength plugin script -->
		<script type="text/javascript" src="<?=HOME; ?>/views/def_view/dash/jquery.pstrength-min.1.2.js" tppabs="http://www.xooom.pl/work/magicadmin/js/jquery.pstrength-min.1.2.js"></script>
        
		<!-- JQuery thickbox plugin script -->
		<script type="text/javascript" src="<?=HOME; ?>/views/def_view/dash/thickbox.js" tppabs="http://www.xooom.pl/work/magicadmin/js/thickbox.js"></script>
        ...
        <div id="header">
            ...
            <div id="header-status">
                <div class="container_12">
                    ...
                    <div class="grid_4">
                        <a href="<?=HOME; ?>/user/logout" id="logout">
                        Logout
                        </a>
                    </div>
                </div>
...
<!--
                ...
                <a href="" class="dashboard-module">
                	<img src="<?=HOME; ?>/views/def_view/dash/Crystal_Clear_user.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/Crystal_Clear_user.gif" width="64" height="64" alt="edit" />
                	<span>Akinlekan Olalekan <br>20141664</span>
                </a>
                <!--
                <a href="" class="dashboard-module">
            ...
            <div class="grid_12">
                ...
                <div class="bottom-spacing">
                    ...
                    <div class="float-right">
                        <a href="" class="button">
                        	<span>New Article <img src="<?=HOME; ?>/views/def_view/dash/plus-small.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/plus-small.gif" width="12" height="9" alt="New article" /></span>
                        </a>
                    </div>
            ...
            <div class="grid_12">
                ...
                <div class="module">
                     ...
                     <div class="module-body">
                        ...
                        <p>
                                <label>TOPIC</label>
                                <input type="text" name="title" rows="3" cols="500" class="input-short"/>
                            </p>
                           
                            <fieldset>

                                <label>UPDATE YOUR NOTICE BOARD</label>
                                <textarea rows="11" cols="76" name="content"> </textarea> 
                            </fieldset>
                            
                            <fieldset>
                                <input class="submit-green" type="submit" name="addNotice" value="Submit" /> 
            ...
            <div class="grid_6">
                ...
                <div style="clear:both;"></div>
            </div> <!-- End .grid_6             <div style="clear:both;"></div>
        ...
        <div id="footer">
        	<div class="container_12">
            	<!--<div class="grid_12">
                	...
                	<p>&copy; 2010. <a href="http://www.templatescreme" title="Visit For More Free Website Templates"></a></p>
        		</div> -->
            </div>
            <div style="clear:both;"></div>
        </div> <!-- End #footer -->
